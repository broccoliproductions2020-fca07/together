/**
 * Runs test-email-verification-gate.js with FUNCTIONS_ENFORCE_EMAIL_VERIFICATION
 * turned on — the one release-gate scenario the regular test:functions suite
 * deliberately does NOT exercise (that suite needs the flag off, since its
 * anonymous test users have no email at all).
 */
...
// The one line this wrapper adds relative to firebase-functions-emulators-exec.js.
process.env.FUNCTIONS_ENFORCE_EMAIL_VERIFICATION = 'true';
